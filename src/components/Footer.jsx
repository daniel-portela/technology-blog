  ...
  return (
    <footer className="footer bg-blue-dark">
      <div className="container">
        <div className="ftr-list">
          <div className="ftr-item">
            <a href="#" className="ftr-brand text-white">
              Technology <span className="ftr-brand-dot bg-white"></span>
            </a>

            <p className="text text-base">
              Tendências no mundo da tecnologia
            </p>
        ...
        <div className="ftr-text text-center text-gray text-base">Copyright &copy; 2024. Daniel Engineer</div>
      </div>
    </footer>
  )
}
